...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            result = Emps.Where(s => s.Salary == Emps.Max(s => s.Salary));
        ...
        public static IEnumerable<object> Task6()
        {
            ...
            result = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (emp, dept) => new
            {
        ...
        public static bool Task8()
        {
            ...
            result = Emps.Any(s => s.Job == "Backend programmer");
        ...
        public static Emp Task9()
        {
            ...
            result = Emps
                     .Where(s => s.Job == "Frontend programmer")
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            result = Emps.Union(new[] { new Emp { Ename = "Brak wartości", Job = null, HireDate = null } });
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            result = Depts.Join(Emps.GroupBy(s => s.Deptno), dept => dept.Deptno, emp => emp.Key,
                        (dept, emp) => new
                        {
                            name = dept.Dname,
                            numOfEmployees = emp.Count()
                        }).Where(s => s.numOfEmployees > 1);
        ...
        public static IEnumerable<Emp> Task12()
        {
            ...
            result = Emps.GetEmpsWithSubordinates().Distinct();
        ...
        {
            int result = 0;
            result = arr.GroupBy(s => s)
                         .Where(number => number.Count() % 2 == 1)
        ...
        public static IEnumerable<Object> Task14()
        {
            ...
            result = Depts.GroupJoin(Emps.GroupBy(s => s.Deptno), dept => dept.Deptno, emp => emp.Key,
                        (dept, emp) => new
                        {
                            name = dept.Dname,
                            numOfEmployees = emp.Count()
